  ...
  pistes: [
    {
      ...
      lecons: [
        ...
        { id:"l2b", fichier:"l02b-tp-texturing-sans-bake.html", titre:"TP : texturer sans bake", niveau:"Débutant", duree:"35 min", desc:"Travaux pratiques sur la caisse : fill layers, smart material, masques peints à la main et relief par height, sans bake ni high-poly. Variante gratuite Blender/ArmorPaint/Material Maker.", motscles:["TP","texturing","sans bake","fill layer","masque","smart material","height","caisse","ArmorPaint","Material Maker","gratuit"] },
        { id:"l2c", fichier:"l02c-tp-bake-export.html", titre:"TP : bake high→low + export moteurs", niveau:"Intermédiaire", duree:"45 min", desc:"Travaux pratiques : baker les mesh maps depuis le high-poly, usure procédurale, puis export et branchement dans Unity, Unreal et Godot, comparé au rendu de référence.", motscles:["TP","bake","high-poly","low-poly","mesh maps","curvature","AO","ORM","export","Unity","Unreal","Godot","channel packing"] },
    ...
    },
    {
      ...
      lecons: [
        ...
        { id:"u6b", fichier:"u06b-tp-synthese-caisse.html", titre:"TP de synthèse : intégrer la caisse", niveau:"Intermédiaire", duree:"40 min", desc:"Travaux pratiques : importer la caisse et ses maps, reconstruire un matériau URP Lit, éclairer et comparer au rendu de référence.", motscles:["TP","synthèse","Unity","URP Lit","import","matériau","Normal map","Smoothness","caisse","intégration moteur"] },
    ...
    },
    {
      ...
      lecons: [
        ...
        { id:"e5b", fichier:"e05b-tp-synthese-caisse.html", titre:"TP de synthèse : intégrer la caisse", niveau:"Intermédiaire", duree:"40 min", desc:"Travaux pratiques : importer la caisse et sa texture ORM, reconstruire le Material (split ORM), éclairer en Lumen et comparer au rendu de référence.", motscles:["TP","synthèse","Unreal","Material","ORM","split","Lumen","import","caisse","intégration moteur"] },
    ...
    },
    {
      ...
      lecons: [
        ...
        { id:"g6b", fichier:"g06b-tp-synthese-caisse.html", titre:"TP de synthèse : intégrer la caisse", niveau:"Intermédiaire", duree:"40 min", desc:"Travaux pratiques : importer la caisse en glTF, reconstruire un StandardMaterial3D, éclairer et comparer au rendu de référence.", motscles:["TP","synthèse","Godot","StandardMaterial3D","glTF","ORM","canaux","WorldEnvironment","caisse","intégration moteur"] },
